...
#define list_head(list, type, member)member\
        list_entry((list)->next, type, member)

#define list_tail(list, type, member)member\
        list_entry((list)->prev, type, member)

#define list_next(elm, member)define\
        list_entry((elm)->member.next, typeof(*elm), member)

#define list_for_each_entry(pos, list, member)list\
        for (pos = list_head(list, typeof(*pos), member);member \
        &pos->member != (list);pos                              \
